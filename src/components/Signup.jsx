    ...
    return (
        <div className='h-screen w-screen flex flex-col login-main items-center justify-center'>
            ...
            <div style={{ height: "50%", width: "100%" }} className='login input2 flex items-center justify-center flex-col'>
                <input className='mb-4' type="text" placeholder='Display name' name="" id="text" />
                <input className='mb-4' type="email" placeholder='Email' name="" id="email" />
                <input className='mb-4' type="password" placeholder='Password' id='password' />
